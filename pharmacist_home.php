          ...
          <div class="row text-center">
            ...
            <div class="col-12 mb-3">
              <form class="d-flex justify-content-center">
                <a href="view_medicines.php" class="btn btn-danger p-3 w-100">View Medicines</a>
              </form>
            </div>

            <div class="col-12 mb-3">
              <form class="d-flex justify-content-center">
                <a href="view_prescriptions.php" class="btn btn-danger p-3 w-100">View Prescriptions</a>
              </form>
            </div>
